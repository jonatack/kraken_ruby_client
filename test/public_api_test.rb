...
class PublicApiTest < Minitest::Test
  ...
  def test_get_assets
    assets = %w(
      ...
      GNO GRT ICX INJ KAR KAVA KAVA.S KEEP KFEE KILT KNC KSM KSM.P KSM.S LINK
      LPT LRC LSK MANA MATIC MINA MIR MKR MOVR NANO OCEAN OGN OMG OXT OXY PAXG
      PERP PHA QTUM RARI RAY REN REPV2 SAND SC SDN SHIB SNX SOL SOL.S SRM STORJ
      SUSHI TBTC TRX UNI USD.HOLD USD.M USDC USDT WAVES WBTC XBT.M XETC XETH
      XLTC XMLN XREP XTZ XTZ.S XXBT XXDG XXLM XXMR XXRP XZEC YFI ZAUD ZCAD ZEUR
      ZGBP ZJPY ZRX ZUSD
    )
