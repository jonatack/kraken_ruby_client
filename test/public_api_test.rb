...
class PublicApiTest < Minitest::Test
  ...
  def test_get_assets
    assets = %w(
      ADA ALGO ATOM ATOM.S BAT BCH BSV CHF COMP DAI DASH DOT DOT.S EOS EUR.M GNO
      ICX KAVA KFEE KNC LINK LSK NANO OMG OXT PAXG QTUM REPV2 SC STORJ TRX USD.M
      USDC USDT WAVES XBT.M XETC XETH XLTC XMLN XREP XTZ XTZ.S XXBT XXDG XXLM
      XXMR XXRP XZEC ZAUD ZCAD ZEUR ZGBP ZJPY ZUSD
    )
