...
class PublicApiTest < Minitest::Test
  ...
  def test_get_assets
    assets = %w(
      AAVE ADA ADA.S ALGO ANT ATOM ATOM.S BAL BAT BCH CHF COMP CRV DAI DASH DOT
      DOT.S EOS ETH2 ETH2.S EUR.HOLD EUR.M EWT FIL FLOW FLOW.S FLOWH FLOWH.S
      GHST GNO GRT ICX KAVA KAVA.S KEEP KFEE KNC KSM KSM.S LINK LSK MANA MATIC
      MKR NANO OCEAN OMG OXT PAXG QTUM RARI REN REPV2 SC SNX STORJ TBTC TRX UNI
