...
class PublicApiTest < Minitest::Test
  ...
  def test_get_assets
    assets = %w(
      ...
      GRT ICX KAVA KAVA.S KEEP KFEE KNC KSM KSM.S LINK LSK MANA MKR NANO OCEAN
      OMG OXT PAXG QTUM REN REPV2 SC SNX STORJ TBTC TRX UNI USD.HOLD USD.M USDC
      USDT WAVES XBT.M XETC XETH XLTC XMLN XREP XTZ XTZ.S XXBT XXDG XXLM XXMR
