...
class PublicApiTest < Minitest::Test
  ...
  def test_get_assets
    assets = %w(
      ...
      QTUM RARI RAY REN REPV2 SAND SC SDN SHIB SNX SOL SOL.S SRM STORJ SUSHI
      TBTC TRX UNI USD.HOLD USD.M USDC USDT WAVES WBTC XBT.M XETC XETH XLTC XMLN
      XREP XTZ XTZ.S XXBT XXDG XXLM XXMR XXRP XZEC YFI ZAUD ZCAD ZEUR ZGBP ZJPY
      ZRX ZUSD
    )
