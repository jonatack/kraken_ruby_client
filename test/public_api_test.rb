...
class PublicApiTest < Minitest::Test
  ...
  def test_get_assets
    assets = %w(
      ...
      BNT CHF CHZ COMP CQT CRV CTSI DAI DASH DOT DOT.S ENJ EOS ETH2 ETH2.S
      ...
      MIR MKR MOVR NANO OCEAN OGN OMG OXT PAXG PERP QTUM RARI REN REPV2 SAND SC
      SNX SOL SOL.S SRM STORJ SUSHI TBTC TRX UNI USD.HOLD USD.M USDC USDT WAVES
      WBTC XBT.M XETC XETH XLTC XMLN XREP XTZ XTZ.S XXBT XXDG XXLM XXMR XXRP
      XZEC YFI ZAUD ZCAD ZEUR ZGBP ZJPY ZRX ZUSD
    )
