...
class PublicApiTest < Minitest::Test
  ...
  def test_get_assets
    assets = %w(
      ADA ALGO ATOM ATOM.S BAL BAT BCH BSV CHF COMP CRV DAI DASH DOT DOT.S EOS
      EUR.HOLD EUR.M FIL FLOW FLOW.S FLOWH FLOWH.S GNO ICX KAVA KFEE KNC KSM
      LINK LSK NANO OMG OXT PAXG QTUM REPV2 SC SNX STORJ TRX UNI USD.M USDC USDT
