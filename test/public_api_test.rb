...
class PublicApiTest < Minitest::Test
  ...
  def test_get_assets
    assets = %w(
      ...
      FLOW.S FLOWH FLOWH.S GHST GNO GRT ICX KAVA KAVA.S KEEP KFEE KNC KSM KSM.P
      KSM.S LINK LPT LSK MANA MATIC MINA MKR NANO OCEAN OGN OMG OXT PAXG PERP
      QTUM RARI REN REPV2 SAND SC SNX SOL SOL.S SRM STORJ SUSHI TBTC TRX UNI
      USD.HOLD USD.M USDC USDT WAVES XBT.M XETC XETH XLTC XMLN XREP XTZ XTZ.S
      XXBT XXDG XXLM XXMR XXRP XZEC YFI ZAUD ZCAD ZEUR ZGBP ZJPY ZRX ZUSD
    )
