...
class PublicApiTest < Minitest::Test
  ...
  def test_get_assets
    assets = %w(
      ADA ALGO ATOM BAT BCH BSV CHF DAI DASH DOT EOS EUR.M GNO ICX KFEE LINK LSK
      NANO OMG OXT PAXG QTUM SC TRX USD.M USDC USDT WAVES XBT.M XETC XETH XLTC
      XMLN XREP XTZ XTZ.S XXBT XXDG XXLM XXMR XXRP XZEC ZAUD ZCAD ZEUR ZGBP ZJPY
      ZUSD
    )
