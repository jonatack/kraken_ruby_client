...
class PublicApiTest < Minitest::Test
  ...
  def test_get_assets
    assets = %w(
      AAVE ADA ADA.S ALGO ANKR ANT ATOM ATOM.S AXS BAL BAT BCH BNT CHF CHZ COMP
      CQT CRV DAI DASH DOT DOT.S ENJ EOS ETH2 ETH2.S EUR.HOLD EUR.M EWT FIL FLOW
      FLOW.S FLOWH FLOWH.S GHST GNO GRT ICX KAR KAVA KAVA.S KEEP KFEE KNC KSM
      KSM.P KSM.S LINK LPT LSK MANA MATIC MINA MKR NANO OCEAN OGN OMG OXT PAXG
      PERP QTUM RARI REN REPV2 SAND SC SNX SOL SOL.S SRM STORJ SUSHI TBTC TRX
      UNI USD.HOLD USD.M USDC USDT WAVES XBT.M XETC XETH XLTC XMLN XREP XTZ
