...
class PublicApiTest < Minitest::Test
  ...
  def test_get_assets
    assets = %w(
      ...
      EOS ETH2 ETH2.S EUR.HOLD EUR.M EWT FIL FLOW FLOW.S FLOWH FLOWH.S GNO GRT
      ICX KAVA KAVA.S KEEP KFEE KNC KSM KSM.S LINK LSK MANA NANO OCEAN OMG OXT
      PAXG QTUM REPV2 SC SNX STORJ TBTC TRX UNI USD.HOLD USD.M USDC USDT WAVES
