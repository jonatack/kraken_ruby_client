...
class PublicApiTest < Minitest::Test
  ...
  def test_get_assets
    assets = %w(
      ...
      EUR.M GNO ICX KAVA KFEE KNC KSM LINK LSK NANO OMG OXT PAXG QTUM REPV2 SC
      SNX STORJ TRX USD.M USDC USDT WAVES XBT.M XETC XETH XLTC XMLN XREP XTZ
      XTZ.S XXBT XXDG XXLM XXMR XXRP XZEC ZAUD ZCAD ZEUR ZGBP ZJPY ZUSD
    )
