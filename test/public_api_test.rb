...
class PublicApiTest < Minitest::Test
  ...
  def test_get_assets
    assets = %w(
      ADA ALGO ATOM BAT BCH BSV CHF DAI DASH EOS GNO ICX KFEE LINK LSK NANO OMG
      OXT PAXG QTUM SC TRX USDC USDT WAVES XETC XETH XLTC XMLN XREP XTZ XTZ.S
      XXBT XXDG XXLM XXMR XXRP XZEC ZCAD ZEUR ZGBP ZJPY ZUSD
    )
