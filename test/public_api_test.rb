...
class PublicApiTest < Minitest::Test
  ...
  def test_get_assets
    assets = %w(
      ...
      FLOWH FLOWH.S GHST GNO GRT ICX KAVA KAVA.S KEEP KFEE KNC KSM KSM.S LINK
      LPT LSK MANA MATIC MINA MKR NANO OCEAN OMG OXT PAXG QTUM RARI REN REPV2
      SAND SC SNX STORJ SUSHI TBTC TRX UNI USD.HOLD USD.M USDC USDT WAVES XBT.M
