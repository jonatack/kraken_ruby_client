...
class PublicApiTest < Minitest::Test
  ...
  def test_get_assets
    assets = %w(
      ADA ALGO ANT ATOM ATOM.S BAL BAT BCH CHF COMP CRV DAI DASH DOT DOT.S EOS
      ETH2 ETH2.S EUR.HOLD EUR.M FIL FLOW FLOW.S FLOWH FLOWH.S GNO ICX KAVA KEEP
      KFEE KNC KSM KSM.S LINK LSK NANO OMG OXT PAXG QTUM REPV2 SC SNX STORJ TBTC
      TRX UNI USD.M USDC USDT WAVES XBT.M XETC XETH XLTC XMLN XREP XTZ XTZ.S
      XXBT XXDG XXLM XXMR XXRP XZEC YFI ZAUD ZCAD ZEUR ZGBP ZJPY ZUSD
    )
