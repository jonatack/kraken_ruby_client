...
class PublicApiTest < Minitest::Test
  ...
  def test_get_assets
    assets = %w(
      1INCH AAVE ADA ADA.S ALGO ANKR ANT ATOM ATOM.S AXS BADGER BAL BAND BAT BCH
      BNC BNT CHF CHZ COMP CQT CRV CTSI DAI DASH DOT DOT.S DYDX ENJ EOS ETH2
      ETH2.S EUR.HOLD EUR.M EWT FIL FLOW FLOW.S FLOWH FLOWH.S GHST GNO GRT ICX
      INJ KAR KAVA KAVA.S KEEP KFEE KNC KSM KSM.P KSM.S LINK LPT LRC LSK MANA
      MATIC MINA MIR MKR MOVR NANO OCEAN OGN OMG OXT OXY PAXG PERP PHA QTUM RARI
      RAY REN REPV2 SAND SC SDN SNX SOL SOL.S SRM STORJ SUSHI TBTC TRX UNI
